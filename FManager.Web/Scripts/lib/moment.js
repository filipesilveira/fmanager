    ...
    ************************************/
    ...
    (function (factory) {
        ...
        return moment.defineLocale('az', {
            ...
            weekdays: 'Bazar_Bazar ert?si_Ç?r??nb? ax?am?_Ç?r??nb?_Cüm? ax?am?_Cüm?_??nb?'.split('_'),
    ...
    (function (factory) {
        ...
        var months = 'leden_únor_b?ezen_duben_kv?ten_?erven_?ervenec_srpen_zá?í_?íjen_listopad_prosinec'.split('_'),
        ...
        function translate(number, withoutSuffix, key, isFuture) {
            ...
            switch (key) {
                ...
                case 'MM': // 9 months / in 9 months / 9 months ago
                    if (withoutSuffix || isFuture) {
                        return result + (plural(number) ? 'm?síce' : 'm?síc?');
                    } else {
    ...
    (function (factory) {
        ...
        return moment.defineLocale('cv', {
            months: '??????_?????_???_???_???_ç?????_???_ç????_????_???_???_??????'.split('_'),
            monthsShort: '???_???_???_???_???_ç??_???_ç??_??_???_???_???'.split('_'),
            weekdays: '???????????_????????_?????????_?????_??ç????????_???????_????????'.split('_'),
            weekdaysShort: '???_???_???_??_??ç_???_???'.split('_'),
            ...
            longDateFormat: {
                ...
                L: 'DD-MM-YYYY',
                LL: 'YYYY [ç????] MMMM [??????] D[-????]',
                LLL: 'YYYY [ç????] MMMM [??????] D[-????], LT',
                LLLL: 'dddd, YYYY [ç????] MMMM [??????] D[-????], LT'
            },
            calendar: {
                sameDay: '[????] LT [???????]',
                nextDay: '[????] LT [???????]',
    ...
    (function (factory) {
        ...
        var weekEndings = 'vasárnap hétf?n kedden szerdán csütörtökön pénteken szombaton'.split(' ');
    ...
    (function (factory) {
        ...
        var units = {
            ...
            weekDays = 'sekmadienis_pirmadienis_antradienis_tre?iadienis_ketvirtadienis_penktadienis_šeštadienis'.split('_');

        function translateSeconds(number, withoutSuffix, key, isFuture) {
            if (withoutSuffix) {
                return 'kelios sekund?s';
            } else {
                return isFuture ? 'keli? sekundži?' : 'kelias sekundes';
            }
        }
        ...
        return moment.defineLocale('lt', {
            months: 'sausio_vasario_kovo_balandžio_geguž?s_birželio_liepos_rugpj??io_rugs?jo_spalio_lapkri?io_gruodžio'.split('_'),
    ...
    (function (factory) {
        ...
        var units = {
            ...
            'MM': 'm?nesi_m?nešus_m?nesis_m?neši',
    ...
    (function (factory) {
        ...
        return moment.defineLocale('tr', {
            ...
            weekdays: 'Pazar_Pazartesi_Sal?_Çar?amba_Per?embe_Cuma_Cumartesi'.split('_'),
